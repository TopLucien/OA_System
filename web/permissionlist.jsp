				                ...
				                <c:forEach var="role" items="${allRoles}">
				                	<tr id="${role.id}">
				                		...
				                		<td>
											...
											<a href="${pageContext.request.contextPath}/deletePermission?roleId=${role.id}" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> 删除</a>
				                		</td>
				                	</tr>
				                </c:forEach>
	                    </tbody>
...
function deletePermission(role_id) {
    $('#roleId').val(role_id);
    $.ajax({
