...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-offset-3 col-md-6" style="text-align: center;margin-left: 27%;margin-top: 12%">
				...
				<form class="form-horizontal" action="login" method="post" id="loginForm">
					...
					<div class="form-group">
						...
						<div class="col-sm-10" style="text-align: center">
							<button type="submit" id="sub" name="sub" class="btn btn-primary" style="margin:9px 147px">登录</button>
						</div>
					</div>
				</form>
			</div>
